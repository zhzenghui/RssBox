...
- (void)viewDidLoad
{
    ...
    NSString *rssFeed = [NSString stringWithFormat:@"http://www.douban.com/feed/review/music"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    workingEntry = [itemRecords objectAtIndex:indexPath.row];
...
- (void)records:(NSMutableArray *)items {
    ...
    [self.itemRecords setArray:items];
