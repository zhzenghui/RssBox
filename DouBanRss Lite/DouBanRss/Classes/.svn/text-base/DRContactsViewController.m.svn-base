...
#import "DRContactsViewController.h"

#import "DRString.h"

@implementation DRContactsViewController
...
- (void)viewDidLoad
{
    ...
    self.title = contacts;
    NSString *rssFeed = [NSString stringWithFormat:@"http://www.douban.com/feed/review/contacts", @""];
